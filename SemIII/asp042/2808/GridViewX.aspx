<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GridViewX.aspx.cs" Inherits="_2808.GridViewX" %>
...
<body style="font-family: Sans-Serif;">
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            DeleteCommand="DELETE FROM [Employee] WHERE [employeeId] = @original_employeeId AND [name] = @original_name AND [designation] = @original_designation AND [city] = @original_city" 
            InsertCommand="INSERT INTO [Employee] ([name], [designation], [city]) VALUES (@name, @designation, @city)" 
            OldValuesParameterFormatString="original_{0}" 
            SelectCommand="SELECT * FROM [Employee]" 
            UpdateCommand="UPDATE [Employee] SET [name] = @name, [designation] = @designation, [city] = @city WHERE [employeeId] = @original_employeeId AND [name] = @original_name AND [designation] = @original_designation AND [city] = @original_city">
            <DeleteParameters>
